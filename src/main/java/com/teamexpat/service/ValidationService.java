...
/**
 * <p>Currently this ValidationService has only one method for validation of missing values in array elements</p>
 * <br>
 * <p><code>Possible improvement</code> will be to add another method to validate the data types contained in the arrays.</p>
